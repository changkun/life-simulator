...
- **Chemical & Biological** — Reaction-Diffusion, BZ Reaction, Chemotaxis, Forest Fire, SIR Epidemic, Lotka-Volterra, Spiking Neural Network, Cellular Potts Model, Artificial Life Ecosystem, Ant Farm, Morphogenesis, Artificial Chemistry, Immune System, Coral Reef, Ecosystem Evolution, Mycelium Network, Primordial Soup & Origin of Life, Firefly Synchronization & Bioluminescence
